...
namespace DotNetMissionSDK.State.Snapshot.Units
{
	...
	/// </summary>
	public class LabState : StructureState
	{
		public int labCurrentTopic													{ get; private set; }
		public int labScientistCount												{ get; private set; }
		...
		public LabState(UnitEx unit, StructureInfo structureInfo, WeaponInfo weaponInfo) : base(unit, structureInfo, weaponInfo)
		{
			labCurrentTopic		= unit.GetLabCurrentTopic();
			labScientistCount	= unit.GetLabScientistCount();
		}
	}
}
